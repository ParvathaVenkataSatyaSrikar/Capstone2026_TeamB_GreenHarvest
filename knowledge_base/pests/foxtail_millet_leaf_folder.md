# Foxtail_Millet — leaf folder management
...
- Sticky honeydew, holes, mines, or wilting may indicate leaf folder.
...
- Neem, BT, or biocontrol where effective for leaf folder.

Category: pests | Crop: foxtail_millet
